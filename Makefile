...
USER_APPS = init testbrk bigstack testfork testio testcvar testexec torture
#List all user program source files here.  SHould be the same as the previous list, with ".c" added to each file
USER_SRCS = init.c testbrk.c bigstack.c testfork.c testio.c testcvar.c testexec.c torture.c
#List the objects to be formed form the user  source files here.  Should be the same as the prvious list, replacing ".c" with ".o"
USER_OBJS = init.o testbrk.o bigstack.o testfork.o testio.o testcvar.o testexec.o torture.o
