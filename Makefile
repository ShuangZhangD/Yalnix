...
USER_APPS = init testbrk testbigstack testfork testexec testttywrite testcvar testttyread torture testpipe testzero testsem
#List all user program source files here.  SHould be the same as the previous list, with ".c" added to each file
USER_SRCS = init.c testbrk.c testbigstack.c testfork.c testexec.c testttywrite.c testttyread.c testcvar.c torture.c testpipe.c testzero.c testsem.c
#List the objects to be formed form the user  source files here.  Should be the same as the prvious list, replacing ".c" with ".o"
USER_OBJS = init.o testbrk.o testbigstack.o testfork.o testexec.o testttywrite.o testttyread.o testcvar.o  torture.o testpipe.o testzero.o testsem.o
